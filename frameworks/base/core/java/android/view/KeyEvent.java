...
public class KeyEvent extends InputEvent implements Parcelable {
	...
	public static final int KEYCODE_TV_KEYMOUSE_MODE_SWITCH = 234;
        ...
        public static final int KEYCODE_TV_ROTATE_LEFT = 235;
        public static final int KEYCODE_TV_ROTATE_RIGHT = 236;
        public static final int KEYCODE_TV_ZOOM_OUT = 237;
        public static final int KEYCODE_TV_ZOOM_IN = 238;
	public static final int KEYCODE_SLEEP=247;
	public static final int KEYCODE_WAKEUP=248;

    private static final int LAST_KEYCODE           =KEYCODE_TV_ZOOM_IN;
	...
	names.append(KEYCODE_WAKEUP,"KEYCODE_WAKEUP");
        ...
        names.append(KEYCODE_TV_MEDIA_PLAY_PAUSE, "KEYCODE_TV_MEDIA_PLAY_PAUSE");
        names.append(KEYCODE_TV_MEDIA_STOP, "KEYCODE_TV_MEDIA_STOP");
        names.append(KEYCODE_TV_MEDIA_NEXT, "KEYCODE_TV_MEDIA_NEXT");
        names.append(KEYCODE_TV_MEDIA_PREVIOUS, "KEYCODE_TV_MEDIA_PREVIOUS");
        names.append(KEYCODE_TV_MEDIA_FAST_FORWARD, "KEYCODE_TV_MEDIA_FAST_FORWARD");
        names.append(KEYCODE_TV_MEDIA_REWIND, "KEYCODE_TV_MEDIA_REWIND");
        names.append(KEYCODE_TV_MEDIA_MULT_FORWARD, "KEYCODE_TV_MEDIA_MULT_FORWARD");
        names.append(KEYCODE_TV_MEDIA_MULT_BACKWARD, "KEYCODE_TV_MEDIA_MULT_BACKWARD");
        names.append(KEYCODE_TV_MEDIA_PLAY, "KEYCODE_TV_MEDIA_PLAY");
        names.append(KEYCODE_TV_MEDIA_PAUSE, "KEYCODE_TV_MEDIA_PAUSE");
